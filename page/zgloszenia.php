...
if(isset($_POST["zgloszenie"]))
{
    ...
    $user->AddPermission();
    echo "<p style='font-size:15pt; color: red;'>Brawo! Zostałeś pracownikiem naszej firmy! Za chwilę zostaniesz przekierowany,
        abyś mógł wykonywać swoją pracę do końca życia. (przyjmujemy każdego po podstawówce, także nie czuj się zbyt specjalnie)</p>";
...
<body>
    <p>
        ...
        -złe samopoczucie<br>
        -stary i nie dynamiczny zespół<br>
